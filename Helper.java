...
public class Helper {
	...
	// If assert fails execution stops on that line, test method will be reported as "Failed"
	public void confirmText(String actual, String expected) {
		Assert.assertEquals(actual, expected);
	}

	public void confirmSingleStringSoft(String actual, String expected) {
	...
	public WebElement fetchElementByIdAndSendKeys(String id, String sendKey) {
		WebElement element = driver.findElement(By.id(id));
		element.sendKeys(sendKey);
		return element;
	}

	public WebElement fetchElementByxPathAndSendKeys(String xPath, String sendKey) {
		WebElement element = driver.findElement(By.xpath(xPath));
		element.sendKeys(sendKey);
		return element;
	}

	public WebElement fetchElementByNameAndSendKeys(String name, String sendKey) {
	...
	public void dropDownByXpath(String xpath, String visibleText) {
